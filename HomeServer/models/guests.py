...
from .utils import TimestampMixin, now_utc, KAMPALA_TZ
...
class Guest(TimestampMixin, database.Model):
    ...
    def check_in(self, room_id: int) -> None:
        ...
        self.checked_in_at = now_utc()

    def check_out(self) -> None:
        """Mark the guest as checked out and release their room."""
        self.status = GuestStatus.CHECKED_OUT
        self.checked_out_at = now_utc()
        self.room_id = None
